...
import { FaWifi, FaComputer, FaSmoking } from "react-icons/fa6";
import { SiNetflix } from "react-icons/si";
import { FaSmokingBan } from 'react-icons/fa';
import { PiThermometerHotFill, PiCookingPotBold, PiDogFill } from "react-icons/pi"
import { GiWineBottle, GiTowel } from "react-icons/gi";
...
const Step3 = () => {
    ...
    return (
        <div className='step3-container flex flex-col justify-center items-center'>
            <h1>객실 등록</h1>

            <div className='step3-box flex flex-col justify-center items-center w-full'>
                ...
                <div className="step3-bed w-full">
                    ...
                    <div className='w-full flex flex-col justify-center items-center gap-2'>
                        {roomTypes.map((room) => (
                        <div className='w-full flex justify-between items-center bed-num'>
                            <p>{room.label}</p>
                ...
                <div className="step3-image w-full">
                    ...
                    <div className='flex flex-col justify-center items-center gap-3 w-full'>
                        <div className="step3-room-image flex justify-center items-center">
                            <img src={image} alt="" />
                        </div>
