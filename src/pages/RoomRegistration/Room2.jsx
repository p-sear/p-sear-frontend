...
const Room2 = () => {
  ...
  return (
    <div className='room2-container flex flex-col items-center justify-center'>
      <h1>객실 등록</h1>

      <div className='room2-box flex w-full flex-col items-center justify-center'>
        <div className='room2-name w-full'>
          <h3>객실 이름</h3>
          <input type='text' placeholder='객실 이름을 입력하세요' />
        </div>

        <div className='room2-width w-full'>
          <h3>면적</h3>
        ...
        <div className='room2-bed w-full'>
          <h3>침대 개수</h3>
        ...
        <div className='room2-standard w-full'>
          <h3>기준 인원</h3>
          <div className='flex w-full items-center justify-center gap-1'>
        ...
        <div className='room2-possible w-full'>
          <h3>수용 인원</h3>
          <div className='flex w-full items-center justify-center gap-1'>
        ...
        <div className='room2-service w-full'>
          <h3>객실 시설</h3>
          <ul className='room2-service-box w-full'>
        ...
        <div className='room2-image w-full'>
          <h3>객실 이미지</h3>
          <div className='flex w-full flex-col items-center justify-center gap-3'>
            <div className='room2-room-image flex items-center justify-center'>
              <img src={image} alt='' />
            </div>
